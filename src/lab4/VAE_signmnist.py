...
if __name__ == "__main__":
    ...
    if os.path.exists(here("models/vae_signmnist.pth")):
      model.load_state_dict(torch.load(here("models/vae_signmnist.pth"), map_location=device))
    ...
    print("Loaded two SignMNIST images for interpolation example. VAE model is trained and loaded.")
# %%
