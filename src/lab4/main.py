...
if __name__ == "__main__":
    ...
    if os.path.exists(here("models/vae_mnist.pth")):
      model.load_state_dict(torch.load(here("models/vae_mnist.pth"), map_location=device))
      print(f"Loaded VAE weights from {here("models/vae_mnist.pth")}")
    else:
      ...
      torch.save(model.state_dict(), here("models/vae_mnist.pth"))
      print(f"Saved trained VAE to {here("models/vae_mnist.pth")}")
    ...
    print("Loaded two MNIST images for interpolation example. VAE model is trained and loaded.")