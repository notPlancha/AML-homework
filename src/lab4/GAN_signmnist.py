...
if __name__ == "__main__":
    ...
    import os
    from pyprojroot import here
    if os.path.exists(here("models/gan_generator_signmnist.pth")) and os.path.exists(here("models/gan_discriminator_signmnist.pth")):
        generator.load_state_dict(torch.load(here("models/gan_generator_signmnist.pth"), map_location=device))
        discriminator.load_state_dict(torch.load(here("models/gan_discriminator_signmnist.pth"), map_location=device))
        ...
        torch.save(discriminator.state_dict(), here("models/gan_discriminator_signmnist.pth"))
    ...
    print("GAN model is trained and loaded. Generated interpolation between random latent vectors.")